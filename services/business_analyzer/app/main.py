...
@app.post("/bmc")
async def business_model_canvas_analysis(request: Request):
    try:
        data = await request.json()
        context = data.get("context")
        business = data.get("business", "Малый бизнес")
...
@app.post("/vpc")
async def value_proposition_canvas_analysis(request: Request):
    try:
        data = await request.json()
        context = data.get("context")
        business = data.get("business", "Малый бизнес")
...
@app.post("/pest")
async def pest_analysis(request: Request):
    try:
        data = await request.json()
        context = data.get("context")
        business = data.get("business", "Малый бизнес")
